package com.androidavanzado.calculadora;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnPunto, btnCero, btnUno, btnDos, btnTres, btnCuatro, btnCinco, btnSeis,
            btnSiete, btnOcho, btnNueve, btnIgual, btnClean, btnMultiplica,
            btnDivide, btnSuma, btnResta, btnBorrar;
    TextView Resultado;
    double resultado;
